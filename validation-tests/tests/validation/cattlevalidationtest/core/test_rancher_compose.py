...
def test_rancher_compose_service_health_check_resiliency(super_client, client, rancher_compose_container,
                                 socat_containers):
    r,d = load_compose_template(srv_res_test_rancher_compose_template, srv_res_test_docker_compose_template)
    run_rancher_compose(client, srv_res_test_rancher_compose_template, srv_res_test_docker_compose_template)


# def test_rancher_compose_lb_healthcheck(super_client, client, rancher_compose_container, socat_containers):
#     r,d = load_compose_template(lb_healthcheck_test_rancher_compose_template, lb_healthcheck_test_docker_compose_template)
#     run_rancher_compose(client, lb_healthcheck_test_rancher_compose_template, lb_healthcheck_test_docker_compose_template)


# def test_services_rolling_upgrade():
#
#
# def test_LB_services_cookies_enabled():
